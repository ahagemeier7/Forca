...
def Jogar():
    ...
    arquivo = open("palavras.txt","r") #Abre o arquivo de texto onde tem as palavras e depois separa por espaço em branco as palavras em uma lista
    texto = arquivo.read()
    ...
    while "_" in palavraEscondida: #O código abaixo vai rodar enquanto todas as letras não estiverem sido descobertas
        ...
        if erros < 5:
            ...
            if letraDigitada in palavraAleatoria: #Se a letra estiver na palavra ele adiciona a letra no indice i da palavra escondida trocando o valor "_" pela letra
                ...
                for letra in palavraEscondida: # printa a palavra escondida '_ a _ a '       
                    print(letra, end=" ") # end= " " printa um espaco a cada letra
                print("")             
            else:
                print("..............")
                print("A letra", letraDigitada, "não está na palavra.")

                erros += 1

                print("Você tem" ,erros, "erro(s) ")
                print("..............")
        else:
            print("Você perdeu!")
    ...
    with open("ranking.txt", "r") as arquivo:
        for linha in arquivo:
            if linha.strip():# valida se existe alguma linha no ranking.txt
                ...
                ranking[nome] = {  # Adiciona os dados como um dicionário para o jogador
                    "acertos": acertos,
